...
const StrokeText = ({
  ...
  const [box, setBox] = useState<BBoxState | null>(null);
  ...
  }, [characters, numFontSize, fontWeight, letterSpacing, strokeWidth]);
  ...
  }, [box, dash, drawDuration, fillDelay, stagger, ease, trigger, fillMode, reverse, scrollStart]);
  ...
  return (
    <span
      ...
      style={{ ...style, ['--stroke-text-height' as string]: `${Math.round(numFontSize * lineHeight)}px` }}
      role="img"
