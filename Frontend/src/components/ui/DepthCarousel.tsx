...
const DEFAULT_ITEMS: DepthCarouselItem[] = [
  { image: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=800&auto=format&fit=crop', alt: 'Slide 1' },
  { image: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?q=80&w=800&auto=format&fit=crop', alt: 'Slide 2' },
  { image: 'https://images.unsplash.com/photo-1538481199705-c710c4e965fc?q=80&w=800&auto=format&fit=crop', alt: 'Slide 3' },
  { image: 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?q=80&w=800&auto=format&fit=crop', alt: 'Slide 4' },
];
      ...
      <div className="depth-carousel__stage" ref={stageRef}>
        {data.map((item, i) => (
          <div
            ...
            onClick={() => onCardClick(i, item.image)}
          >
        ...
        <div className="depth-carousel__dots" role="tablist" aria-label="Slides">
          {data.map((_, i) => (
            <button
              ...
              onClick={(e) => { e.stopPropagation(); setFocus(i, true); }}
            />
          ))}
        </div>
      )}
