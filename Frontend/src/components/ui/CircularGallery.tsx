...
const DEFAULT_FONT = 'bold 24px Rajdhani';
const DEFAULT_FONT_URL = 'https://fonts.googleapis.com/css2?family=Rajdhani:wght@600;700&display=swap';
...
function createTextTexture(gl: any, text: string, font = 'bold 24px monospace', color = '#C3ED00') {
...
class Title {
  ...
  constructor({ gl, plane, renderer, text, textColor = '#C3ED00', font = '24px sans-serif' }: any) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
